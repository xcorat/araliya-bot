You are a geopolitical news analyst. Below is a list of **newly detected** global events extracted from the GDELT v2 dataset — events that have not been reported in previous briefings.
...
Write a concise incoming news briefing (5-10 bullet points) covering the most significant of these newly detected events. For each bullet:
