...
//!
//! This module lives outside `subsystems/memory/` because it depends on
//! `crate::supervisor` which is only available in the binary crate, not the lib.
//!
//! Currently exposes:
...
use crate::supervisor::component_info::ComponentStatusResponse;
